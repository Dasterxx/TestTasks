...
public class DifferentStrategies {
    ...
    public List<List<Color>> test1() {
        return List.of(
                List.of(c(1), c(2), c(3), c(1)),
                List.of(c(2), c(3), c(4), c(2)),
                List.of(c(3), c(4), c(5), c(3)),
                List.of(c(4), c(5), c(6), c(4)),
                List.of(c(5), c(6), c(7), c(5)),
                List.of(c(6), c(7), c(8), c(6)),
                List.of(c(7), c(8), c(9), c(7)),
                List.of(c(8), c(9), c(10), c(8)),
                List.of(c(9), c(10), c(11), c(9)),
                List.of(c(10), c(11), c(12), c(10)),
                List.of(c(11), c(12), c(1), c(11)),
                List.of(c(12), c(1), c(2), c(12)),
                List.of(),
                List.of()
        );
    }
